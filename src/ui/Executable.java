...
public class Executable {
	...
	private void menu() {
		...
		while (!flag) {
			...
			System.out.println("6. Generar reporte de usuarios registrados");
	...
	private void registerUser() {
		...
		// Limpieza de buffer
		reader.nextLine();
		System.out.println("Digite el tipo de usuario a registrar \n1.Regular \n2.Premium");
		...
		int optionCA = 0;
		if(optionUser==2){
			System.out.println("Digite que tipo categoria desea \n1.Silver \n2.Gold \n3.Diamond");
			optionCA = reader.nextInt();
		}
		Calendar signUpDate = Calendar.getInstance();
		if (rXSystem.registerUser(id, name, nickname,optionUser, optionCA, signUpDate)) {
	...
	private void modifyUser() {
		...
		if (query.equals("")) {
			...
			if(rXSystem.checkUser(optionUser)) {
				System.out.println("Digite el nuevo nombre del usuario");
				newName = reader.nextLine();
				System.out.println("Digite la nueva categoria del usuario \n1.Silver \n2. Gold \n3. Diamond");
				newCategory = reader.nextInt();
			} else {
				System.out.println("Digite el nuevo nombre del usuario");
				newName = reader.nextLine();
			}
			if (rXSystem.editUser(optionUser - 1,newName,newCategory)) {
	...
	private void showUserReport(){
		...
		System.out.println("A continuacion se presentara el reporte de usuarios en el sistema");
		System.out.println("--------------------------------------------------------------------");
		System.out.println(rXSystem.userReport());
		System.out.println("--------------------------------------------------------------------");
	}
}